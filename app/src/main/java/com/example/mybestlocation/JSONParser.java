...
public class JSONParser {
    ...
    String paramsString;
    //ta3tih url ykhrjlk json object
...
//            Lit la réponse ligne par ligne et la stocke dans result.
            ...
            Log.e("JSON Parser", "Error during HTTP request: " + e.getMessage());
            e.printStackTrace();
            return null;  // Return null if there is an error in the request
        } finally {
            if (conn != null) {
                conn.disconnect();
            }
...
//                Convertit la chaîne de caractères obtenue en un objet JSON.
                ...
                return null;  // Return null if there is an error parsing the JSON
            }
        } else {
            Log.e("JSON Parser", "Empty or null response");
            return null;
        }
